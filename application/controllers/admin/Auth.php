...
================================================== */
    ...
    public function order_mail_config()
    {
        ...
        $this->form_validation->set_rules('message', lang("order_mail"), 'trim|xss_clean|required');
        $this->form_validation->set_rules('reservation_message', lang('reservation_mail'), 'trim|xss_clean|required');
        $this->form_validation->set_rules('order_receiver_mail', lang("order_receiver_mail"), 'trim|xss_clean|required');
        if ($this->form_validation->run() == false) {
            $this->session->set_flashdata('error', validation_errors());
    ...
    public function install_profile()
    {
        ...
        $this->form_validation->set_rules('city_id', lang('city_name'), 'trim|required');
        if ($this->form_validation->run() == false) {
            $this->session->set_flashdata('error', validation_errors());
            redirect($_SERVER['HTTP_REFERER']);
        } else {
