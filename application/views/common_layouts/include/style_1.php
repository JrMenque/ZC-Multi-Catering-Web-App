     ...
     <ul>
         <?php if ($shop['is_language'] == 1) : ?>
             <?php if (sizeof($language) > 1) : ?>
                 <li class="navDropdownMenu menuDropdown"><a class="nav-link p-r" href="javascript:;"><i class="icofont-globe"></i> &nbsp;<span class="allow-lg"><?= lang_slug(!empty(auth('site_lang')) ? auth('site_lang') : $settings['language']); ?> <i class="icofont-rounded-down"></i></span></a>
