             ...
             <ul class="navbar-nav">
                 ...
                 <li class="navDropdownMenu"><a href="javascript:;" class=""><?= lang('more'); ?> <i class="icofont-rounded-down"></i></a>
                     ...
                     <div class="navDropdownList" style="display:none;">
                         <ul class="pt-0">
                             ...
                             <?php if (is_feature($id, 'reservation') == 1 && is_active($id, 'reservation')) : ?>
                                 <li class="nav-item"><a class="" href="<?= url('reservation/' . $slug); ?>"> <?= get_features_name('reservation'); ?></a></li>
                             <?php endif; ?>
                 ...
                 <?php else : ?>
                     <?php if (isset($shop['is_language']) && $shop['is_language'] == 1) : ?>
                         <li class="navDropdownMenu"><a class="nav-link p-r" href="javascript:;"> <?= lang_slug(!empty(auth('site_lang')) ? auth('site_lang') : $settings['language']); ?> <i class="icofont-rounded-down"></i></a>
                             <div class="navDropdownList" style="display: none;">
                                 <ul>
                 ...
                 <?php __menu(1, '', false, $is_sidebar = true); ?>
             </ul><!-- navBar -->
         </div><!-- topbarbody -->
     </div>
     <div class="topFooter">
