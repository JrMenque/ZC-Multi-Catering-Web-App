			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
						...
						<input type="text" name="purchase_code" class="form-control" value="1234567890" readonly>
					</div>
					<div class="form-group">
						<label>Script Purchase Code</label>
						<input type="text" name="script_purchase_code" class="form-control" value="1234567890" readonly>
					</div>
				</div>
