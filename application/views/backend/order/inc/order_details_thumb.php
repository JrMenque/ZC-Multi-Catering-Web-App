                                        ...
                                        <tr class="bolder text-left">
                                            ...
                                            <td colspan="2">
                                                <div class="bottomPrice">
                                                    ...
                                                    <?php else : ?>
                                                        <?php if ($p->tax_fee != 0) : ?>
                                                            <p class="flex-between"><span><?= lang('tax'); ?> (<span class="text-sm"><?= tax($p->tax_percent, restaurant()->tax_status); ?></span>)</span>
                                                    ...
                                                    <?php if ($p->coupon_percent != 0) : ?>
                                                        <p class="flex-between"><span><?= lang('coupon_discount'); ?> </span>
                                                            <b><?= currency_position($p->coupon_percent, $shop_id); ?>
                                                            </b>
                                                        </p>
                                                    <?php endif; ?>
                                ...
                                <?php if ($order['is_payment'] == 1) : ?>
                                    ...
                                    <li>
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <?php else : ?>
                                                <h3 class="timeline-header"> <label class="label bg-success-soft"><i class="fa fa-check"></i> <?= lang('paid'); ?>
                                                        <?= currency_position(@$paymentInfo['price'], $shop_id); ?>
                                                        &nbsp;</label></h3>
                                            <?php endif ?>
