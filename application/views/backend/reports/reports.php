        ...
        <div class="filterButtonGroup flex-1">
            <div class="form-group">
                <div class="ci-input-group">
                    <input type="text" name="daterange" class="form-control" value="<?= isset($_GET['daterange']) ? $_GET['daterange'] : full_date(today()); ?>">
                        ...
                        <thead>
                            <tr class="zReportHeader">
                                <td>
                                    ...
                                    <p><?= lang('date'); ?> : <?= isset($_GET['daterange']) && !empty($_GET['daterange']) ? $_GET['daterange'] : full_date(today()); ?></p>
                                </td>
                            </tr>
                        </thead>
                    </table>
