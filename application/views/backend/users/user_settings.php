<div class="row resoponsiveRow">
    ...
    <div class="col-md-8">
        <form class="email_setting_form" action="<?= base_url('admin/auth/add_email_settings') ?>" method="post"
                            ...
                            <div class="email_content">
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="">
                                                <input type="text" name="smtp_mail"
                                                    placeholder="<?= lang('contact_email'); ?>" class="form-control"
                                    ...
                                    <div class="form-group col-md-12">
                                        <label
                                            class=""><?= !empty(lang('default_email'))?lang('default_email'):"Default Email";?></label>
                                        <div class="">
                                            <select name="email_type" class="form-control email_option">
                                                <option value="1"
                                                    <?= isset($settings['email_type']) && $settings['email_type']==1?'selected':''?>>
                                                    <?= lang('php_mail'); ?></option>
                                                <option value="2"
                                                    <?= isset($settings['email_type']) && $settings['email_type']==2?'selected':''?>>
                                                    <?= lang('smtp'); ?></option>
                                                <option value="3"
                                                    <?= isset($settings['email_type']) && $settings['email_type']==3?'selected':''?>>
                                ...
                                <div class="row">
                                    ...
                                    <div class="smtpArea "
                                        style="display:<?= isset($settings['email_type'])  &&  $settings['email_type']==2?'block':'none'?>">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="">
                                                <input type="text" name="smtp_host"
                                                    placeholder="<?= lang('smtp_host'); ?>" class="form-control"
                                        ...
                                        <div class="form-group col-md-6 ">
                                            ...
                                            <div class="">
                                                <input type="text" name="smtp_port"
                                                    placeholder="<?= lang('smtp_port'); ?>" class="form-control"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="">
                                                <input type="password" name="smtp_password"
                                                    ...
                                                    value="<?= !empty($smtp['smtp_password'])?html_escape(base64_decode($smtp['smtp_password'])):'';  ?>"
                                                    autocomplete="off">
                                ...
                                <div class="row sendGrid">
                                    <div class="sendGrid"
                                        style="display: <?= isset($settings['email_type']) && $settings['email_type']==3?'block':'none'?>;">
                                        <div class="form-group col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-left">
                                        <a href="<?= base_url("admin/auth/test_mail");?>" target="blank"
