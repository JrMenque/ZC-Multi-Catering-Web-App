                ...
                <div class="card-body">
                    <div class="">
                        ...
                        <div class="custom-control custom-switch prefrence-item m-0">
                            <div class="gap">
                                <input type="checkbox" id="is_order_mail" name="is_order_mail" class="switch-input "
                                    <?= isset($mail->is_order_mail) && $mail->is_order_mail==1?"checked" : "" ;?>>

                                <label for="is_order_mail" class="switch-label"> <span class="toggle--on"> <i
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="subject" class="form-control"
                            value="<?= !empty($mail->subject)?$mail->subject:'';?>" required>
                    </div>

                    <div class="form-group">
                        <label><?= lang('order_receive_mail');?> <span class="error">*</span></label>
                        <input type="text" name="order_receiver_mail" class="form-control"
                            value="<?= !empty($mail->order_receiver_mail)?$mail->order_receiver_mail:$settings['smtp_mail'];?>"
                            required>
                    </div>
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <textarea name="message" class="form-control textarea" cols="5" rows="15"
                                required><?= !empty($mail->message)?json_decode($mail->message):'';?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="mt-5 flex-gap gap-30">
                            <label class="custom-checkbox"><input type="checkbox" name="is_owner_mail"
                                    id="is_owner_mail" value="1"
                                    <?= isset($mail->is_owner_mail) && $mail->is_owner_mail==1?"checked" :"";;?>>
                                <?= lang('restaurant_owner');?></label>

                            <label class="custom-checkbox"><input type="checkbox" name="is_dboy_mail" id="is_dboy_mail"
                                    value="1"
                                    <?= isset($mail->is_dboy_mail) && $mail->is_dboy_mail==1? "checked":"";;?>>
                                <?= lang('delivery_staff');?></label>

                            <label class="custom-checkbox"><input type="checkbox" name="is_customer_mail"
                                    id="is_customer_mail" value="1"
                                    <?= isset($mail->is_customer_mail) && $mail->is_customer_mail==1? "checked":"";;?>>
                    ...
                    <div class="reservationMailSection fill-background">
                        ...
                        <div class="form-group">
                            <label><?= lang('subject');?> <span class="error">*</span></label>
                            <input type="text" name="rev_subject" class="form-control"
                                value="<?= !empty($mail->rev_subject)?$mail->rev_subject:'';?>" required>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <textarea name="reservation_message" class="form-control textarea" cols="5" rows="15"
                                    required><?= !empty($mail->reservation_message)?json_decode($mail->reservation_message):'';?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="mt-5 flex-gap gap-30">
                                <label class="custom-checkbox"><input type="checkbox" name="is_rev_owner_mail"
                                        id="is_rev_owner_mail" value="1"
                                        <?= isset($mail->is_rev_owner_mail) && $mail->is_rev_owner_mail==1?"checked" :"";;?>>
                                    <?= lang('restaurant_owner');?></label>

                                <label class="custom-checkbox"><input type="checkbox" name="is_rev_customer_mail"
                                        id="is_rev_customer_mail" value="1"
                                        <?= isset($mail->is_rev_customer_mail) && $mail->is_rev_customer_mail==1? "checked":"";;?>>
                                    <?= lang('customer_mail');?></label>
                            </div>
                        </div>
