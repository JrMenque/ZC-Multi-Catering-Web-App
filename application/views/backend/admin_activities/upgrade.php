				...
				<div class="box-body">
					...
					<div class="row">
					    ...
					    <div class="form-group col-md-12">
					        ...
					        <input type="text" name="purchase_code" id="title" class="form-control" placeholder="<?= !empty(lang('new_purchase_code'))?lang('new_purchase_code'):"New Purchase code";?>" value="1234567890" readonly>
					    </div>
