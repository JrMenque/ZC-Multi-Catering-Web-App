					...
					<div class="categoryList posheader">
						<ul class="posCatList">
							<?php foreach ($category_list as $key => $cat) : ?>
								...
								<li><a href="<?= base_url("admin/pos/ajax_pagination?catId=" . md5(multi_lang(auth('id'), $cat))); ?>" data-id="<?= multi_lang(auth('id'), $cat); ?>" class="bg-success-soft catId">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="menuItemList">
								<ul>
									<li><a href="javascript:;"  data-type="items" class="softHover active getItems"><?= lang('items'); ?></a></li>
...
<div class="categoryArea">
	<div class="categoryAreaContent">
		...
		<div class="categoryList">
			...
			<ul>
				<li><a href="<?= base_url("admin/pos/ajax_pagination?catId=all"); ?>" class="softHover active catId">
						<div class="categoryDiv ">
				...
				<?php foreach ($category_list as $key => $cat) : ?>
					<li><a href="<?= base_url("admin/pos/ajax_pagination?catId=" . md5(multi_lang(auth('id'), $cat))); ?>" class="softHover catId">
							<div class="categoryDiv">
								<img src="<?= get_img($cat['thumb'], '', 1); ?>" alt="">
								<span><?= $cat['name']; ?></span>
							</div>
