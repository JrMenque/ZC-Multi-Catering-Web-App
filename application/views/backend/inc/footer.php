...
<script src="<?php echo base_url() ?>assets/admin/bower_components/bootstrap-daterangepicker/daterangepicker.js">
</script>

<!-- bootstrap color picker -->
<script src="<?php echo base_url() ?>assets/admin/bower_components/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js">
</script>
...
<!-- time picker.js -->
<script src="<?php echo base_url() ?>assets/admin/bower_components/bootstrap-timepicker/js/bootstrap-timepicker.js">
</script>

<!-- datepicker -->
<script src="<?php echo base_url() ?>assets/admin/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js">
</script>
<!-- DataTables -->
<script src="<?php echo base_url() ?>assets/admin/bower_components/datatables.net/js/jquery.dataTables.min.js">
</script>
...
<!-- Slimscroll -->
<script src="<?php echo base_url() ?>assets/admin/bower_components/jquery-slimscroll/jquery.slimscroll.min.js">
</script>
...
<script src="<?php echo base_url() ?>assets/admin/dist/js/demo.js?v=<?= settings()['version']; ?>&time=<?= time(); ?>">
</script>
...
<?php if (isset($page_title) && $page_title == "Items") : ?>
  <link rel="stylesheet" href="<?= base_url('public/plugins/cropper.css'); ?>" />
  <script src="<?= base_url('public/plugins/cropper.js') ?>"></script>
<?php endif; ?>
...
<?php if (isset($page_title) && $page_title != 'Edit profile' && isset($page_title) && $page_title != 'Restaurant Configuration' && isset($page_title) && $page_title != 'Profile' && isset($page_title) && $page_title != 'KDS') : ?>
    ...
    <?php if (auth('user_role') == 1) : ?>
      ...
      <?php endif; ?>
      <!-- gtranslate -->
      <?php if (isset($page_title) && $page_title != 'Cities') : ?>
                ...
                <div class="form-group">
                  ...
                  <select name="city_id" id="city_id" class="form-control select2" required>
                    ...
                    <?php foreach ($cityList as  $key => $city) : ?>
                      <option value="<?= $city['id']; ?>"><?= $city['city_name']; ?> - <?= $city['zip_code']; ?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
              </div>
