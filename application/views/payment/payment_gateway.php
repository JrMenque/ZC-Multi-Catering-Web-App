                ...
                <div class="card mt-50 payment_card">
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs payment_nav">
                            ...
                            <li
                                class="nav-item <?=  isset($_GET['method']) && $_GET['method']==$pay['slug']?"active":"";?>">
                                <a class="nav-link"
                                    href="<?= base_url("profile/payment/{$slug}?method={$pay['slug']}") ;?>"><span
                                        class="payout_img"
                                        style="background:url(<?=  base_url(IMG_PATH.'payout/'.$pay['slug'].'.png');?>)"></span><?= lang($pay['slug']) ;?></a>
                            </li>
                            <?php endif;?>
                            <?php endif;?>
                            <?php endforeach; ?>
