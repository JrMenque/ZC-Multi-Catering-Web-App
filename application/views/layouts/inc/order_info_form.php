					...
					<div class="form-group col-md-6">
						...
						<div class="customPhone">
							<div class="ci-input-group">
								...
								<input type="text" name="phone" class="form-control remove_char only_number" autocomplete="off" data-char="+" placeholder="e.g. 1408XXXXXXX">
							</div>
						</div>
			...
			<div class="form-group col-md-6">
				...
				<select name="order_type" id="order_type_list" class="form-control order_type <?= !empty(temp('is_table')) ? "pointerEvent" : ""; ?>" data-id="<?= $shop_id; ?>">
					...
					<?php foreach ($order_type as $key => $types) : ?>
						<option value="<?= $types['type_id']; ?>" data-radius="<?= isset($shop_info['is_radius']) ? $shop_info['is_radius'] : 0; ?>" data-required="<?= $types['is_required']; ?>" data-pay="<?= $types['is_payment']; ?>" data-slug="<?= $types['slug']; ?>" <?= !empty(temp('is_table')) && $types['slug'] == "dine-in" ? "selected" : ""; ?>>
					...
					<div class="form-group col-md-12 cod_phone" style="display: none;">
						...
						<div class="customPhone">
							<div class="ci-input-group">
								...
								<input type="text" name="cod_phone" class="form-control remove_char only_number" autocomplete="off" data-char="+" placeholder="e.g. 1408XXXXXXX">
							</div>
						</div>
