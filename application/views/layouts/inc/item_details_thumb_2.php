        ...
        <div class="singleItemContent">
          <div class="itemTitle">
            <h4>
              ...
              <?php if (isset($item->veg_type) && $item->veg_type != 0) : ?> <i class="fa fa-circle veg_type <?= $item->veg_type == 1 ? 'c_green' : 'c_red'; ?>" data-placement="top" data-toggle="tooltip" title="<?= veg_type($item->veg_type); ?>"></i><?php endif; ?>
            </h4>
            ...
            <?php if ($item->is_size == 0) : ?>
              <div class="itemVariants mt-10">
                <label class="variant-btn active"> <input type="radio" name="item_size" data-price="<?= __numberFormat($item->price, $shop_id) ?>" data-size="" data-size-title="" value="<?= __numberFormat($item->price, $shop_id) ?>" checked>
                  <span class="variantPrice"> <?= currency_position($item->price, $shop_id) ?></span></label>
                </div>
              <?php endif; ?>
              <!-- price without sizes -->
    ...
    <div class="modal-footer">
      <div class="modalFooterArea">
        ...
        <div class="addToCartbutton">
          ...
          <input type="hidden" name="item_price" value="<?= $item->is_size == 0 ? $item->price : 0; ?>">
