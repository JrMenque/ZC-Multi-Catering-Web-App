                                ...
                                <div class="left_package_details_signup with_package pricing_3 w_100">
                                    <div class="card mb-5 mb-lg-0 signupCard col-md-4">
                                        <div class="card-body">
                                            ...
                                            <h6 class="card-price text-center">
                                                <?= !empty(lang('free'))?lang('free'):'Free';?><span
                                                    class="period">/<?= !empty(lang('month'))?lang('month'):'month';?></span>
                                            </h6>

                                            <?php else: ?>
                                            <h6 class="card-price text-center">
                                                <?= admin_currency_position(html_escape($package['price'])) ;?><span
                                                    class="period"> /
                                            ...
                                            <ul class="fa-ul">
                                                ...
                                                <li><span class="fa-li"><i class="fas fa-check c_green"></i></span>
                                                    <?= html_escape($feature['features']);?></li>
                                                <?php else: ?>
                                                <li class="text-muted"><span class="fa-li"><i
                                                            class="fas fa-times c_red"></i></span>
                                                    <?= html_escape($feature['features']);?></li>
                                                <?php endif;?>
                                                <?php endforeach ?>
                                            </ul>
                                    ...
                                    <div class="col-md-8 bg_white">
                                        <form action="<?= base_url('login/user_registration/'.$slug).$ref_id ;?>"
                                            ...
                                            <div class="login_form">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="username" id="username"
                                                        class="form-control"
                                                        placeholder="<?= !empty(lang('restaurant_username'))?lang('restaurant_username'):"Restaurant username";?>"
                                                        autocomplete="off">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="g-recaptcha"
                                                        data-sitekey="<?= $this->settings['recaptcha']->site_key;?>">
                                                    </div>
                                                    <?php endif;?>
                                                    <?php endif;?>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="pointer"> <input type="checkbox" name="terms"
                                                            value="1">&nbsp; <?= lang('read_terms'); ?><a
                                                ...
                                                <div class="form-group">
                                                    <button type="submit" class="btn btn-info reg_btn"><i
